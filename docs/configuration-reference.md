...
| ------------------------- | ---------------------- | ----------- | ----------------------------------------------------------------------------------------------------------- |
| `fuelType`                | `string` or `string[]` | `'P95'`     | Fuel type code(s) (see valid fuel types below). Can be a single fuel type string or an array of fuel types. |
...
// Multiple fuel types - premium unleaded and diesel
config: {
    fuelType: ['P95', 'DL'],
    brands: ['Caltex', 'Shell', 'BP'],
    limit: 5
